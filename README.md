About ds-lime-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ds-lime-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/datascienceinc/lime

Documentation: https://marcotcr.github.io/lime/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4645&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ds-lime-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ds-lime` can be installed with `conda`:
...
```
mamba install ds-lime
```

It is possible to list all of the versions of `ds-lime` available on your platform with `conda`:
...
```
mamba search ds-lime --channel conda-forge
```
...
mamba repoquery search ds-lime --channel conda-forge

# List packages depending on `ds-lime`:
mamba repoquery whoneeds ds-lime --channel conda-forge

# List dependencies of `ds-lime`:
mamba repoquery depends ds-lime --channel conda-forge
```
